        ...
        "/v1/user/profile": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Cursor for pagination (last seen ID) for posts",
                        "name": "cursor",
                        "in": "query",
                        "required": true
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SearchUserRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.SearchUserResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/v1/user/search/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Limit for posts to fetch at once",
                        "name": "limit",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Cursor for pagination to fetch posts",
                        "name": "cursor",
                        "in": "query",
                        "required": true
                    }
